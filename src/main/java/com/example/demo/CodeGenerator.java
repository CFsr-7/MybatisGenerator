...
//                        .setService("/template/ser.java")
//                        .setServiceImpl("/template/iml.java")
//                        .setMapper("/template/map.java")
//                        .setEntity("/template/en.java")
        );
        // 执行生成
        mpg.execute();
    }
